    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      l10n?.exportDataTitle ?? 'Esporta codici',
                  ...
                  Expanded(
                    child: Text(
                      l10n?.exportCodesCount(contacts.length) ??
                          "${contacts.length} codici fiscali pronti per l'esportazione",
                      style: theme.textTheme.bodyMedium?.copyWith(
          ...
          Text(
            l10n?.exportFormatLabel ?? 'Scegli il formato',
          ...
          _FormatOptionCard(
            ...
            title: l10n?.exportFormatJsonTitle ?? 'JSON (.json)',
          ...
          _FormatOptionCard(
            ...
            title: l10n?.exportFormatCsvTitle ?? 'CSV (.csv)',
